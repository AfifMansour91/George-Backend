        ...
        public AutoMapperProfile()
        {
            ...
            CreateMap<Account, AccountRes>()
                ...
                .AfterMap((src, dest, context) =>
                {
                    ...
                    // Account-level response keeps exposing the account DEFAULT row (SiteId == null);
                    // per-site overrides are served by GET /Account/{id}/notification-settings?siteId=.
                    var defaultNotifRow = NotificationSettingsResolver.Resolve(src.AccountNotificationSettings, siteId: null);
                    dest.NotificationSettings = defaultNotifRow != null
                        ? NotificationSettingsMapper.ToRes(defaultNotifRow)
                        : null;
