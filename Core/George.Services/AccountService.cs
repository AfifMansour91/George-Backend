...
namespace George.Services
{
    public class AccountService : ServiceBase
    {
        ...
        private static AccountNotificationSettings MapNotificationSettingsReqToEntity(int accountId, NotificationSettingsReq req)
        {
            ...
            {
                AccountId = accountId,
                NewOrderManagerSoundEnabled = n?.ManagerSoundEnabled ?? true,
                NewOrderManagerSoundKey = string.IsNullOrWhiteSpace(n?.ManagerSoundKey) ? null : n.ManagerSoundKey,
                NewOrderManagerSoundTriggerWebsite = trig?.Website ?? true,
                NewOrderManagerSoundTriggerKiosk = trig?.Kiosk ?? true,
                NewOrderManagerSoundTriggerWhatsapp = trig?.Whatsapp ?? false,
                NewOrderManagerSoundTriggerPhone = trig?.Phone ?? false,
                NewOrderManagerMessageChannel = string.IsNullOrWhiteSpace(n?.ManagerMessageChannel) ? null : n.ManagerMessageChannel,
                NewOrderManagerPhoneNumbers = string.IsNullOrWhiteSpace(n?.ManagerPhoneNumbers) ? null : n.ManagerPhoneNumbers,
                NewOrderManagerMessageTemplate = string.IsNullOrWhiteSpace(n?.ManagerMessageTemplate) ? null : n.ManagerMessageTemplate,
                NewOrderManagerReminderBeforeDeliveryEnabled = n?.ManagerReminderBeforeDeliveryEnabled ?? false,
                NewOrderManagerReminderBeforeDeliveryMinutes = n?.ManagerReminderBeforeDeliveryMinutes ?? 60,
                NewOrderManagerReminderNoTreatmentEnabled = n?.ManagerReminderNoTreatmentEnabled ?? false,
                NewOrderManagerReminderNoTreatmentMinutes = n?.ManagerReminderNoTreatmentMinutes ?? 15,
                NewOrderManagerReminderNoTreatmentSoundKey = string.IsNullOrWhiteSpace(n?.ManagerReminderNoTreatmentSoundKey) ? null : n.ManagerReminderNoTreatmentSoundKey,
                NewOrderCustomerChannel = string.IsNullOrWhiteSpace(n?.CustomerChannel) ? null : n.CustomerChannel,
                NewOrderCustomerMessageShipping = string.IsNullOrWhiteSpace(n?.CustomerMessageShipping) ? null : n.CustomerMessageShipping,
                NewOrderCustomerMessagePickup = string.IsNullOrWhiteSpace(n?.CustomerMessagePickup) ? null : n.CustomerMessagePickup,
                NewOrderCustomerMessageKiosk = string.IsNullOrWhiteSpace(n?.CustomerMessageKiosk) ? null : n.CustomerMessageKiosk,
                NewOrderCustomerSmsOnPhoneOrderEnabled = n?.CustomerSmsOnPhoneOrderEnabled ?? false,
                NewOrderCustomerMessagePhoneOrder = string.IsNullOrWhiteSpace(n?.CustomerMessagePhoneOrder) ? null : n.CustomerMessagePhoneOrder,
                OrderReadyManagerNotifyEnabled = r?.ManagerNotifyEnabled ?? false,
                OrderReadyCustomerChannel = string.IsNullOrWhiteSpace(r?.CustomerChannel) ? null : r.CustomerChannel,
                OrderReadyCustomerMessageShipping = string.IsNullOrWhiteSpace(r?.CustomerMessageShipping) ? null : r.CustomerMessageShipping,
                OrderReadyCustomerMessagePickup = string.IsNullOrWhiteSpace(r?.CustomerMessagePickup) ? null : r.CustomerMessagePickup,
                OrderReadyCustomerMessageKiosk = string.IsNullOrWhiteSpace(r?.CustomerMessageKiosk) ? null : r.CustomerMessageKiosk,
                OrderNotPickedUpManagerNotifyEnabled = u?.ManagerNotifyEnabled ?? false,
                OrderNotPickedUpAutoReminderEnabled = u?.AutoReminderEnabled ?? false,
                OrderNotPickedUpMinutesAfterScheduledPickup = u?.MinutesAfterScheduledPickup ?? 30,
                OrderNotPickedUpCustomerMessageTemplate = string.IsNullOrWhiteSpace(u?.CustomerMessageTemplate) ? null : u.CustomerMessageTemplate,
                AfterDeliveryEnabled = a?.Enabled ?? false,
